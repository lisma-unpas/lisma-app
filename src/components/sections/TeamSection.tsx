...
const team = [
  {
    name: 'Naufal',
    role: 'Ketua Umum',
    image: '/images/executive/ketum.jpg',
    instagram: ['siabrek']
  },
  {
    name: 'Rizal',
  ...
  },
  {
    name: 'Dezan',
    role: 'Ketua Dua',
    image: '/images/executive/uwa.jpg',
    instagram: ['dejncndrrraaaaaaaa']
  },
  {
    name: 'Syauqi',
    role: 'Ketua Tiga',
    image: '/images/executive/kutil.jpg',
  ...
  {
    name: 'Rizqi & Ghefira',
    role: 'Koordinator/ Wakil KDS',
    image: '/images/executive/koor-waor-kds.jpg',
    instagram: ['rizqirukmanaa', 'ghefiranurlatifaa']
  },
  {
    name: 'Addri & Egga',
    role: 'Koordinator/ Wakil PSM',
    image: '/images/executive/koor-waor-psm.jpg',
    ...
    <section id="tim" className="py-16 bg-white">
      <Container>
        ...
        <MotionDiv
          ...
          className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-wrap lg:justify-center gap-6 md:px-12 justify-items-center lg:justify-items-stretch"
        >
          {team.map((member, index) => (
            <MotionDiv
              key={index}
              variants={item}
              className="group relative overflow-hidden rounded-lg shadow-md transition-all duration-300 hover:shadow-xl w-full max-w-[280px] md:max-w-none lg:w-[calc(25%-1.125rem)]"
            >
              {/* Foto anggota */}
              <div className="aspect-[3/4] w-full overflow-hidden">
                <Image
                  ...
                  width={200}
                  height={266}
                  className="h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 object-contain"
                />
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 
                ...
                {/* Instagram Icons */}
                {member.instagram && member.instagram.length > 0 && (
                  <div className="flex justify-center mt-3 gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    {member.instagram.map((handle, idx) => (
                      <a
                        key={idx}
